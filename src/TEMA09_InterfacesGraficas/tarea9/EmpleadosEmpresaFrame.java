 ...
 * @author Ruper
 */
public class EmpleadosEmpresaFrame extends javax.swing.JFrame {
    private EmpleadosEmpresa empresa;
    /**
     * Creates new form IG_EmpleadosEmpresa
     */
    public EmpleadosEmpresaFrame() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmpleadosEmpresaFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EmpleadosEmpresaFrame().setVisible(true);
            }
        });
    }
