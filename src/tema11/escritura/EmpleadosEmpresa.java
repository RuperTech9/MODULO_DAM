...
public class EmpleadosEmpresa {
    ...
    // Método para guardar los datos de empleados en un archivo de texto
    private static void guardarEmpleadosEnArchivo() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(".\\src\\tema11\\escritura\\empleados.txt"))) {
            for (Empleado empleado : empleados) {
                writer.write(empleado.toString());
                writer.newLine();
            }
            JOptionPane.showMessageDialog(null, "Los datos de empleados se han guardado en el archivo.");
        } catch (IOException e) {
            JOptionPane.showMessageDialog(null, "Error al guardar los datos de empleados en el archivo.");
        }
    }
    ...
    public void mostrarMenu() {
        // Llamar al método para leer los empleados desde el archivo al iniciar el programa
        leerEmpleadosDesdeArchivo();
        ...
        // Llamar al método para guardar los empleados en el archivo al salir del programa
