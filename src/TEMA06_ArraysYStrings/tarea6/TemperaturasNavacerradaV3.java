 ...
 * @author Ruper
 */
public class TemperaturasNavacerradaV3 {
    ...
    // CONSTRUCTOR
    public TemperaturasNavacerradaV3() {
        inicializarDatos();
        cargarDatosEnero();
        cargarDatosFebrero();
    } // FIN CONSTRUCTOR
    ...
    public void imprimirMes(int mes) {
        ...
        // Inicializar variables para encontrar las temperaturas máxima y mínima
        int temperaturaMaxima = Integer.MIN_VALUE; // Iniciar con el valor más bajo posible
        int temperaturaMinima = Integer.MAX_VALUE; // Iniciar con el valor más alto posible
