...
public class SocioGestion {
    ...
    static String rutaSocios = ".\\src\\examen3Evaluacion\\ficheros\\socios.txt";
    static String rutaSociosAntiguos = ".\\src\\examen3Evaluacion\\ficheros\\sociosAntiguos.txt";
    ...
    static void guardarAltaEnArchivo(Socio socio) {
        ...
        File archivo = new File(".\\src\\examen3Evaluacion\\altasSocios\\alta_" + nombreArchivo + ".txt");
    ...
    static void guardarBajaEnArchivo(Socio socio) {
        System.out.print("Introduce el nombre del archivo para este socio (sin .txt): ");
        String nombreArchivo = sc.next();
        File archivo = new File(".\\src\\examen3Evaluacion\\bajasSocios\\baja_" + nombreArchivo + ".txt");
